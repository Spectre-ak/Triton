...
<?php
	...
	//show the list of all posts sorted by the no of likes from the networkPosts.php
...
<script>
	...
	<body style="background-color: #131316;">
		...
		<div class="container" >
			<ul class="nav nav-tabs nav-justified">
				<li class="nav-item" style="background-color: #131316;">
					...
					role="tab" data-toggle="tab" id="1" onclick="window.location.href = 'https://sqltry3.azurewebsites.net/uploads/loginsignup/SpaceShuttel.php';"><i class="fa fa-home" style="color: #0c82e2"></i> Space Shuttel</a>
				</li>
				<li class="nav-item" style="background-color: #131316">
        ...
        <script>
			...
			function addAPIsPosts(response,noOfLikes,conditionForAppendingInAllusersDivOrAfterScrollingdiv){
		        ...
		        wholePost.appendChild(line);
				if(conditionForAppendingInAllusersDivOrAfterScrollingdiv)
					document.getElementById("allUsersPostDiv").appendChild(wholePost); 
				else
		        	document.getElementById("apisPostLocation").appendChild(wholePost);
    ...
    //gtiZgqXuP8f3OPyjqu21ysauFO8mCOyDPjRKwhJq
    //https://api.nasa.gov/planetary/apod?api_key=gtiZgqXuP8f3OPyjqu21ysauFO8mCOyDPjRKwhJq

  /*    runtimeerror api key: HQv9ho1mQR9um5vu34dEhP5lsedm95MEYOz3rfBh
  nikhil: W9OdIjEe1fWDQYstoh8lHgf1GtHKBAdbkS1VzcQ5
  mars photo: https://api.nasa.gov/mars-photos/api/v1/rovers/curiosity/photos?sol=1000&api_key=DEMO_KEY
