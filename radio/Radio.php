        ...
        var allUsers=[];
          ...
          function disp(flagForLoadSearchResultsOrLoadDefaultResult,pro,name,username,flagForConnectorDisconnect,flagForChat,flagForAcceptOrRejectConnections,flagForSentConnections){
            ...
            if(flagForAcceptOrRejectConnections){
              ...
              ele.onclick=function(){AcceptOrRejectRequest(username,this,eleR);};
              eleR.onclick=function(){AcceptOrRejectRequest(username,this,ele);};
              ...
              ele.className='btn btn-primary'
              ele.onclick=function(){cancelSentRequest(username,this);};
              ...
              if(flagForChat){
                ...
                span.innerHTML=icon;
                span.onclick=function(){chatWithUser(username,name)};
                p2.appendChild(span);
              }
...
<script> 
        ...
        if(flagForNotLoadingHistoryAgain){
          ...
          for(var i=0;i<tobeSorted.length;i++){
            ...
            if(ar[2]==thisUserOrignalName)//sent message
              ...
              sendAndReceiveMessageUIUpdate(ar[2],ar[1],ar[3],false);
          }
    ...
    function sendMessage(argument) {
      ...
      if(messageToSend.length==0)alert("Invalid Message");
        ...
        var messageArray={"message":messageToSend,"nameToDisplay":thisUserOrignalName,"OrignalTime":cleanedCurrtime,"timeToDisplay":time};
...
<div class="container" >
  <ul class="nav nav-tabs nav-justified">
      ...
      <li class="nav-item" style="background-color: #131316" >
        <a class="nav-link active" href="#alberto" role="tab"
    ...
    <!-- <div class="container" >
      <ul class="nav nav-tabs justify-content-center">
        ...
        <li onclick="LoadFollowers();" class="nav-item">
          <a class="nav-link" data-toggle="tab" id="22" href="#"><i class="fa fa-users" aria-hidden="true" style="color: #0c82e2"></i> Your connections</a>
        </li>
              ...
              $.ajax({
                  ...
                  .done(function(data) {
                      ...
                      if(ele.innerHTML=="Connect"){
                        ele.innerHTML="Request Sent";ele.disabled=true;
                      }
