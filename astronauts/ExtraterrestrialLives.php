...
function disp(pro, name, username, flag) {
	...
	if(flag) ele.innerHTML = 'Follow';
	else ele.innerHTML = 'Unfollow';
  ...
  ">
	...
	<div class="container">
		<ul class="nav nav-tabs nav-justified">
			...
			<li class="nav-item" style="background-color: #131316">
				<a class="nav-link active" href="#danny" role="tab" data-toggle="tab" id="2" onclick="window.location.href = 'https://sqltry3.azurewebsites.net/uploads/loginsignup/ExtraterrestrialLives.php';"><i class="fa fa-users" aria-hidden="true"></i> Astronauts</a>
			</li>
			<li class="nav-item" style="background-color: #131316">
