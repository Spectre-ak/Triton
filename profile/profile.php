...
<div class="container" >
	<ul class="nav nav-tabs nav-justified">
        ...
        <li class="nav-item" style="background-color: #131316" >
          <a class="nav-link active" href="#agumbe"role="tab" 
    ...
    <div style="text-align: center; ">
      <div class="container">
        ...
        <div style="text-align: center;margin-top: -14%">
          <img src="" id="profileImgId" class="img-fluid" alt="Responsive image" 
          height="25%" width="25%" style=" max-heigth:4px; border-radius:50% 50% 50% 50%;">
        </div>   
      </div>   
    </div>
